...
const Footer = () => {
  ...
  return (
    <footer className="px-4 py-16 border-t border-[#333333]">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-[#FFFFFF] ">Stackcompare</h3>
            ...
            <div className="flex space-x-4">
              <div className="w-8 h-8 neumorphic-card rounded-lg flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
                <span className="text-[#CCCCCC] text-sm">𝕏</span>
              </div>
              <div className="w-8 h-8 neumorphic-card rounded-lg flex items-center justify-center cursor-pointer hover:scale-110 transition-transform">
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category} className="space-y-4">
              <h4 className="text-[#FFFFFF] font-semibold ">{category}</h4>
              <ul className="space-y-3">
                {links.map((link) => (
                  <li key={link}>
                    <a href="#" className="text-[#CCCCCC] hover:text-[#FFFFFF] transition-colors text-sm">
                      {link}
                    </a>
                  </li>
                ))}
        ...
        <div className="mt-16 neumorphic-card p-8">
          <div className="text-center space-y-4">
            <h3 className="text-2xl font-bold text-[#FFFFFF] ">Stay Updated</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 bg-[#1A1A1A] border border-[#333333] rounded-xl px-4 py-3 text-[#FFFFFF] placeholder-text-secondary focus:border-accent focus:ring-1 focus:ring-accent"
              />
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-[#333333] flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
          <p className="text-[#CCCCCC] text-sm">
            © 2024 Stackcompare. All rights reserved.
          </p>
          <div className="flex items-center space-x-6">
            <a href="#" className="text-[#CCCCCC] hover:text-[#FFFFFF] text-sm transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-[#CCCCCC] hover:text-[#FFFFFF] text-sm transition-colors">
              Terms of Service
