    ...
    <div className="min-h-screen bg-primary">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground  mb-4">Compare Tech Stacks</h1>
          <p className="text-foreground-secondary text-lg">Select up to 2 tech stacks to compare side by side</p>
        </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-foreground-secondary">{stack.stats.githubStars}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Download className="w-4 h-4 text-green-500" />
                        <span className="text-foreground-secondary">{stack.stats.npmDownloads}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <TrendingUp className="w-4 h-4 text-accent" />
                        <span className="text-foreground-secondary">{stack.stats.jobOpenings}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Users className="w-4 h-4 text-purple-500" />
                        <span className="text-foreground-secondary">Popular</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <div className="space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {selectedStacks.map((stack, index) => (
                <Card key={stack.id} className="neumorphic-card border-0">
                  <CardHeader>
                    <CardTitle className="text-foreground ">{stack.name}</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Popular Companies</h4>
                      <p className="text-foreground-secondary text-sm">{stack.stats.companies}</p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">Key Stats</h4>
              ...
              <CardContent className="p-8">
                ...
                <div className="flex justify-center space-x-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-foreground-secondary">Better for modern web apps</div>
                  </div>
                  <ArrowRight className="w-6 h-6 text-foreground-secondary mt-2" />
                  <div className="text-center">
                    <div className="text-lg font-semibold text-green-400">{selectedStacks[1].name}</div>
                    <div className="text-sm text-foreground-secondary">Better for traditional websites</div>
                  </div>
                </div>
              </CardContent>
            </Card>
