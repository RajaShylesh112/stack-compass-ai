    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="neumorphic-card p-6">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            <h2 className="text-2xl font-bold text-[#FFFFFF]  mb-2">{recommendation.name}</h2>
            <p className="text-[#CCCCCC] mb-4">{recommendation.description}</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            ...
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.githubStars}</div>
            <div className="text-xs text-[#CCCCCC]">GitHub Stars</div>
          </CardContent>
        </Card>
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            <Download className="w-6 h-6 text-green-500 mx-auto mb-2" />
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.npmDownloads}</div>
            <div className="text-xs text-[#CCCCCC]">Weekly Downloads</div>
          </CardContent>
        </Card>
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            <GitBranch className="w-6 h-6 text-blue-500 mx-auto mb-2" />
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.contributors}</div>
            <div className="text-xs text-[#CCCCCC]">Contributors</div>
          </CardContent>
        </Card>
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            <Users className="w-6 h-6 text-purple-500 mx-auto mb-2" />
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.communitySize}</div>
            <div className="text-xs text-[#CCCCCC]">Community</div>
          </CardContent>
        </Card>
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            <TrendingUp className="w-6 h-6 text-[#A259FF] mx-auto mb-2" />
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.jobMarket}</div>
            <div className="text-xs text-[#CCCCCC]">Job Openings</div>
          </CardContent>
        </Card>
        <Card className="neumorphic-card border-0">
          <CardContent className="p-4 text-center">
            <AlertCircle className="w-6 h-6 text-orange-500 mx-auto mb-2" />
            <div className="text-lg font-bold text-[#FFFFFF]">{stats.lastUpdate}</div>
            <div className="text-xs text-[#CCCCCC]">Last Update</div>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <Card className="neumorphic-card border-0">
          <CardHeader>
            <CardTitle className="text-[#FFFFFF] ">Market Adoption</CardTitle>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
              ...
              {marketShare.map((entry, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-[#CCCCCC] text-sm">{entry.name}</span>
                  </div>
      ...
      <Card className="neumorphic-card border-0">
        <CardHeader>
          <CardTitle className="text-[#FFFFFF] ">Adoption by Company Size</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <Card className="neumorphic-card border-0">
          <CardHeader>
            <CardTitle className="text-[#FFFFFF]  text-green-400">Pros</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2">
              {recommendation.pros.map((pro, index) => (
                <li key={index} className="flex items-start space-x-2">
                  ...
                  <span className="text-[#CCCCCC]">{pro}</span>
                </li>
              ))}
            </ul>
          </CardContent>
        ...
        <Card className="neumorphic-card border-0">
          <CardHeader>
            <CardTitle className="text-[#FFFFFF]  text-red-400">Considerations</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="space-y-2">
              {recommendation.cons.map((con, index) => (
                <li key={index} className="flex items-start space-x-2">
                  ...
                  <span className="text-[#CCCCCC]">{con}</span>
                </li>
              ))}
            </ul>
          </CardContent>
      ...
      <div className="flex justify-center space-x-4">
        ...
        <Button 
          variant="outline"
          className="border-[#333333] text-[#CCCCCC] hover:text-[#FFFFFF] px-8 py-3 text-lg"
        >
